...
#define HAL_GET_INTR_NESTING()    interrupt_get_nest()
#define HAL_INTR_NESTING_DEC()    hal_intr_nesting_dec_comm()
#define HAL_INTR_NESTING_INC()    hal_intr_nesting_inc_comm()
#define HAL_ENTER_CRITICAL()  hw_interrupt_disable()
#define HAL_EXIT_CRITICAL(level)  hw_interrupt_enable(level)
#define HAL_INTR_ATTACH(vecotr,isr) //TODO 该写什么？
#define HAL_SCHED_BRIDGE() hw_context_switch()
//#define HAL_INTR_EXIT_BRIDGE() hal_intr_exit_bridge_comm()
#define HAL_INTR_EXIT_BRIDGE() hw_context_switch_interrupt()
